...
class PbiEmbedService:
    ...
    def get_RLSembed_params_for_single_report(self, workspace_id, report_id, additional_dataset_id=None, loggedin_user=None):
        '''Get embed params for a report and a workspace
        ...
        embed_token = self.get_RLSembed_token_for_single_report_single_workspace(report_id, dataset_ids, workspace_id, loggedin_user)
        embed_config = EmbedConfig(embed_token.tokenId, embed_token.token, embed_token.tokenExpiry, [report.__dict__])
        return json.dumps(embed_config.__dict__)
    ...
    def get_RLSembed_token_for_single_report_single_workspace(self, report_id, dataset_ids, target_workspace_id=None, loggedin_user=None):
        '''Get Embed token for single report, multiple datasets, and an optional target workspace
